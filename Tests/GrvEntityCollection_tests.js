...
/// <reference path="../Build/entityspacgrv.debug.js" />

module('GrvEntityCollection_tests.js');

test('Basic Collection Smoke Test', function () {

    var coll = new grv.objects.EmployeesCollection();
...
test('Collection.MarkAsDeleted Test', function () {
    ...
    var i, arr, koArr,
        coll = new grv.objects.EmployeesCollection();
