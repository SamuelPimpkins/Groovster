...
grv.GroovsterEntity = function () { //empty constructor
    ...
    this.init = function () {
        ...
        self.grv.___esEntity___ = grv.utils.newId(); // assign a unique id so we can test objects with this key, do equality comparison, etc...
                ...
                if (data.hasOwnProperty(prop)) {
                    ...
                    if (this.grvTypeDefs && this.grvTypeDefs[prop]) {
                        ...
                        if (EntityCtor) {
                            ...
                            entityProp = new EntityCtor();
                            if (entityProp.grv.hasOwnProperty('___grvCollection___')) { //if its a collection call 'populateCollection'
