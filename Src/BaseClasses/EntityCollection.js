...
grv.GroovsterEntityCollection = function () {
    ...
    obs.grv['___grvCollection___'] = grv.utils.newId(); // assign a unique id so we can test objects with this key, do equality comparison, etc...
    ...
    rejectChanges: function () {
        ...
        if (addedEntitiorm.length > 0) {
            for (index = addedEntitiorm.length - 1; index >= 0; index--) {
                this.grv.deletedEntitiorm.splice(addedEntities[index], 1);
            }
        }
